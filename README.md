...
PawPal+ now includes smarter scheduling features:
- Tasks are automatically sorted by time for clear daily planning.
- You can filter tasks by completion status or by pet.
